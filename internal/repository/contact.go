...
import (
	...
	"github.com/alireza-fa/phone-book/pkg/crypto"
	"github.com/lib/pq"
	"go.uber.org/zap"
	"strconv"
	"strings"
...
func (r *repository) UpdateContact(userId uint64, contact *models.Contact) error {
	in := []interface{}{contact.Name, pq.Array(contact.Phones), contact.Description, userId, contact.Id}
...
func (r *repository) DeleteContact(userId uint64, contactId uint64) error {
	in := []interface{}{userId, contactId}
